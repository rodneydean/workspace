...
import { Search, Github as GithubIcon, MessageSquare } from 'lucide-react';
      ...
      <footer className="border-t border-border/40 py-12 bg-muted/30">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-10">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="https://skyrme.chat" className="hover:text-foreground transition-colors">Website</a></li>
                <li><a href="https://app.skyrme.chat" className="hover:text-foreground transition-colors">Open App</a></li>
        ...
        <div className="container mt-12 pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/skyrme-chat/skyrme-chat" className="text-muted-foreground hover:text-foreground transition-colors">
              <GithubIcon className="h-4 w-4" />
            </a>
          </div>
        </div>
